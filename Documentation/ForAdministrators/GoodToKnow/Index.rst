	...
	plugin.tx_powermail {
		...
		settings {
			...
			misc {
				...
				# cat=powermail_additional//1040; type=boolean; label= Force JavaScript Datepicker: Per default html5 Date or Datetime format is used. If you don't want to use it and want to have the same datepicker all over all browsers, you can enable this feature
